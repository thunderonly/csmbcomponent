...
<div class="modal hide fade" id="collapseModal-Word">
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal">&#215;</button>
		<h3><?php echo JText::_('COM_CSMBCOMPONENT_WORD_TITRE'); ?></h3>
	</div>
	<div class="form-horizontal">
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
				<div class="control-group" style="margin-left: 10px; margin-top: 10px">
					<?php echo JHtml::_('word.saison'); ?>
				</div>
			</div>
		</div>
	...
	<div class="modal-footer">
		...
		<button class="btn btn-primary" type="submit" onclick="Joomla.submitbutton('adherents.word');">
			<?php echo JText::_('COM_CSMBCOMPONENT_MAIL_ENVOYER'); ?>
		</button>
	</div>
</div>
